...
#import "HAMParentViewController.h"

@interface HAMParentViewController ()
{
...
@implementation HAMParentViewController
...
- (void)refreshCoursewareSelect
{
    ...
    coursewareArray = [self.coursewareManager userList];
